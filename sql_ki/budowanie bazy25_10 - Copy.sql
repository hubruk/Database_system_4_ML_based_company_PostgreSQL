...
CREATE TABLE IF NOT EXISTS ai_med."Okres przyjmowania leku"
(
    id serial NOT NULL DEFAULT nextval('ai_med."Aktualnie przyjmowane leki_id_seq"'::regclass),
...
ALTER TABLE IF EXISTS ai_med."Okres przyjmowania leku"
    ADD FOREIGN KEY (id)
